...
public class MazeMainGUI implements MouseMotionListener, MouseListener, KeyListener{
	 ...
	 * 1.) New Button:
	 * Disable focusable
	 * Add button to start maze function for it to be disabled.
	 * Add button to stop maze function for it to be enabled.  
	 * 
	 */
	...
	private void initialize() {
		...
		eraserThicknessSlider = new JSlider(JSlider.HORIZONTAL, minEraserThickness, maxEraserThickness, initialEraserThickness);
		...
		colorComboBox.setModel(new DefaultComboBoxModel<String>(new String[] {"Black", "Red", "Yellow", "Orange", "Pink", "Purple", "Blue", "Gray", "Green",
				"Brown", "Lavender", "Navy Blue", "Army Green", "Plum", "Turquoise", "Maroon", "Storm", "Salmon"}));
		...
		startMazeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(CheckForStartAndEndLocations() == true) {
					...
					DisableButtonsForStartMaze(startLocationButton, endLocationButton, freeDrawButton, startMazeButton, eraserButton
							, loadMazeButton, saveMazeButton, horizontalLineButton, verticalLineButton, clearMazeButton, saveMazeAsImageButton,
							colorComboBox, enemiesButton);
		...
		stopMazeButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EnableButtonsForStopMaze(startLocationButton, endLocationButton, freeDrawButton, startMazeButton, eraserButton
						, loadMazeButton, saveMazeButton, horizontalLineButton, verticalLineButton, clearMazeButton, saveMazeAsImageButton,
						colorComboBox, enemiesButton);
				stopMazeButton.setEnabled(false);
			}
		...
		clearMazeButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				if(JOptionPane.showConfirmDialog(null, "Are you sure you want to clear the maze?") == JOptionPane.YES_OPTION) {
	...
	private void ChangeStartLabelToPlayerLabel(JPanel mazePanel) {
		...
		this.player.setBounds(startLocation.getBounds());
		mazePanel.add(this.player);
		this.player.setVisible(true);
		Player.SetPlayerImage(this.player);
	}
	
	private void DisableButtonsForStartMaze(JButton startLocationButton, JButton endLocationButton, JButton freeDrawButton, JButton startMazeButton,
			JButton eraserButton, JButton loadMazeButton, JButton saveMazeButton, JButton horizontalLineButton, JButton verticalLineButton,
			JButton clearMazeButton, JButton saveMazeAsImageButton, JComboBox<String> colorComboBox, JButton enemiesButton) {
	...
	private void EnableButtonsForStopMaze(JButton startLocationButton, JButton endLocationButton, JButton freeDrawButton, JButton startMazeButton,
			JButton eraserButton, JButton loadMazeButton, JButton saveMazeButton, JButton horizontalLineButton, JButton verticalLineButton,
			JButton clearMazeButton, JButton saveMazeAsImageButton, JComboBox<String> colorComboBox, JButton enemiesButton) {
